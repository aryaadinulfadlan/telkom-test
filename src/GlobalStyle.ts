...
export const NolKoma7to1rem = 'clamp(0.7rem, 0.6565rem + 0.1935vw, 0.85rem)'
...
// export const FontSize1x = 'clamp(2.5rem, 1.9808rem + 2.3077vw, 4rem)'
// export const FontSize1x = 'clamp(3rem, 2.3077rem + 3.0769vw, 5rem)'
// export const FontSize1x = 'clamp(5rem, 3.2692rem + 7.6923vw, 10rem)'
// export const FontSize1x = 'clamp(7rem, 5.2692rem + 7.6923vw, 12rem)'